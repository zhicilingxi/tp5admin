<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\wamp\www\tp5cms\public/../application/admin\view\base.html";i:1554194027;s:53:"D:\wamp\www\tp5cms\application\admin\view\header.html";i:1554431046;s:50:"D:\wamp\www\tp5cms\application\admin\view\top.html";i:1554101127;s:51:"D:\wamp\www\tp5cms\application\admin\view\left.html";i:1554186211;s:53:"D:\wamp\www\tp5cms\application\admin\view\footer.html";i:1554431044;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script src="/static/admin/plugins/ckeditor/ckeditor.js"></script>
  ...
  <!--[if lt IE 9]>
  <script src="/static/admin/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="/static/admin/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
</head>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/static/admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/static/admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/article/"><i class="fa fa-circle-o text-red"></i> <span>文章列表</span></a></li>
        <li><a href="/admin/Setting/modulelist/"><i class="fa fa-circle-o text-red"></i> <span>模块列表</span></a></li>
     -->  
     ...
     <li class="  treeview">
          ...
          <ul class="treeview-menu">
    		 <?php foreach($v['urls'] as $ks=>$vs){?>
            <li class=""><a href="<?php echo $vs['url'];?>"><i class="<?php echo $vs['icon'];?>"></i> <?php echo $vs['name'];?></a></li>
    		 <?php }?>
          </ul>
        </li>
     <?php }?>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="/admin/Setting/modulelist/"><i class="fa fa-dashboard"></i> 首页</a></li>
			<?php if(!empty($ParentNav)){?>
            <li><a href="<?=$ParentNav['url']?>"><?=$ParentNav['name']?></a></li>
			<?php } ?>
          </ol>
        </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="row">
        <?php include ('../application/admin/view/'.$_view.'.html') ?>
      </div>
    </section>
    <!-- /.content -->
  </div>
...
<script src="/static/admin/dist/js/jquery.cookie.js"></script>
<!-- Bootstrap 3.3.6 -->
